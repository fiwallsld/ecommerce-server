...
const corsOption = {
  origin: ["http://localhost:3000", "http://localhost:3001", "*", "https://fiwallsld.github.io"],
  methods: ["GET","HEAD","PUT","PATCH","POST","DELETE"],
  allowedHeaders: ["Content-Type", "x-requested-with","Access-Control-Allow-Headers", "Authorization", "Origin", "Accept", "x-client-key", "x-client-token", "x-client-secret"],
